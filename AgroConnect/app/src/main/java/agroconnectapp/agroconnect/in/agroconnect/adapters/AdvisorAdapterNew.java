...
import agroconnectapp.agroconnect.in.agroconnect.activities.AgroWebView;
 ...
 */
public class AdvisorAdapterNew extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public AdvisorAdapterNew(Context context, List<AdvisorEntity> entityList, RecyclerView recyclerView) {
