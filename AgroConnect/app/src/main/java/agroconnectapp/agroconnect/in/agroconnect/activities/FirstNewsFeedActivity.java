...
import agroconnectapp.agroconnect.in.agroconnect.adapters.FirstNewsFeedAdapter;
 ...
 */
public class FirstNewsFeedActivity extends AgroActivity {

    private int feedId;
    private RecyclerView recyclerView;
    private ArrayList<CommentEntity> entityList = new ArrayList<>();
    private FirstNewsFeedAdapter adapter;
    ...
    private void getDataFromServer() {
        ...
        ServerCommunication.INSTANCE.getServerData(FirstNewsFeedActivity.this, true, true, Request.Method.GET, NEWS_FEED_URI + "/" + feedId, NEWS_FEED_URI, paramMap, new ServerCommunication.OkuTaskListener() {
            @Override
            public void onPostExecute(String result) {
                ...
                if (!TextUtils.isEmpty(result)) {
                    try {
                        ...
                        adapter = new FirstNewsFeedAdapter(FirstNewsFeedActivity.this, jsonObject, feedId, entityList);
    ...
    private void getCommentFromServer() {
        ...
        ServerCommunication.INSTANCE.getServerDataByGet(FirstNewsFeedActivity.this, true, url, "", new ServerCommunication.OkuTaskListener() {
            @Override
            public void onPostExecute(String result) {
                if (!TextUtils.isEmpty(result)) {
                    try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Utils.takeScreenShotAndShare(FirstNewsFeedActivity.this, recyclerView);
        }
